...
async def read_model_status(region_code: str) -> dict:
    """현재 서버 예측에 사용하는 모델 계열과 저장된 모델 목록을 반환합니다."""
    import json
    import joblib

    from ..ml.gangnam_forecast import ARTIFACT_DIRECTORY
    from ..ml.model_switch_002 import get_active_model_family
    ...
    try:
        ...
        raise HTTPException(status_code=503, detail='통합 ML 모델 파일을 읽지 못했습니다.') from exc
    families = artifact.get('models_by_family', {})
    ...
    return {
        ...
        'trained_model_families': list(families.keys()),
        ...
        'evaluation_by_family': metadata.get('evaluation_by_family', {}),
    }
